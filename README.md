...
#### Shadowrocket (iOS) ⭐ Рекомендуется
...
5. Выбери **Scan QR Code** или **Import from Clipboard**
6. Если ссылка в буфере — выбери **Import from Clipboard**
7. Нажми **Save**
8. Включи переключатель вверху для подключения
...
- В Shadowrocket должен появиться зелёный индикатор
- Открой браузер и проверь IP: https://ifconfig.me
